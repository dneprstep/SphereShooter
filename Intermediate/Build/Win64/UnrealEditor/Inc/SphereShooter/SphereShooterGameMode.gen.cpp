...
template<> SPHERESHOOTER_API UScriptStruct* StaticStruct<FSpawnLocData>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SphereShooter_Source_SphereShooter_SphereShooterGameMode_h_Statics::ScriptStructInfo[] = {
		{ FGameData::StaticStruct, Z_Construct_UScriptStruct_FGameData_Statics::NewStructOps, TEXT("GameData"), &Z_Registration_Info_UScriptStruct_GameData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameData), 615788889U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SphereShooter_Source_SphereShooter_SphereShooterGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASphereShooterGameMode, ASphereShooterGameMode::StaticClass, TEXT("ASphereShooterGameMode"), &Z_Registration_Info_UClass_ASphereShooterGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASphereShooterGameMode), 1781746794U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SphereShooter_Source_SphereShooter_SphereShooterGameMode_h_569546522(TEXT("/Script/SphereShooter"),
